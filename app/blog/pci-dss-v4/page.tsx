...
export default function Page() {
  return <BlogArticle eyebrow="Payment security" title="PCI DSS v4.0.1: A practical transition guide" description="A focused roadmap for moving from readiness to evidence-based compliance while keeping payment data, controls, and teams aligned." readTime="Full guide" pdfUrl="/blog/pci-dss-v4-0-1.txt" sections={[
